...
estrangeiros. O Pelourinho e o Elevador são alguns dos principais pontos de visitação.','2020-08-06','2020-08-10','854','True','Salvador')
...
Praia do Forte e Costa do Sauipe.','14/05/2020','18/05/2020','1826.00','True','Salvador')
...
ecológicas, passeios de bote e descidas de rapel pelas inúmeras quedas d''agua da
região.','28/03/2020','01/04/2020','1004.00','True','Bonito');